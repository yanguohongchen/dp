...
public class GenericDefaultPage<T> implements IGenericPage<T>
{
	 ...
	 * 
	 * @see
	 * com.harmony.framework.query.generic.IGenericPage#getThisPageElements()
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.harmony.framework.query.generic.IGenericPage#
	 ...
	 * 
	 * @see
	 * com.harmony.framework.query.generic.IGenericPage#getThisPageLastElementNumber
	 * ()
	 */
