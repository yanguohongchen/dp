define(function(require, exports, module) {
	...
	var common = {
		...
		config : {
			// requestUrl : ["api/"],
			requestUrl : ["http://localhost:8080/dp-web/"],
		...
		user : {
			...
			api : {
				sertUserInfo : function(sid, encryptKey, userId) {
		...
		ajax : {
			...
			_request : function(block, serverIndex, action, params, care, callback) {
				...
				var ajaxurl = common.config.api.getRequestUrl(serverIndex) + action;
				$.ajax({
					//地址格式
					// url : '192.168.253.166',
					url : ajaxurl,
...
//						alert("error");
	...
	module.exports = {
		...
		getTemplate : function(module, template) {
			return common.ui.getTemplate(module, template);
		}
	}
